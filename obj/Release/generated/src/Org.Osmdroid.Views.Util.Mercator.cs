...
namespace Org.Osmdroid.Views.Util {
	...
	public partial class Mercator : global::Java.Lang.Object {
		...
		public static global::Osmdroid.Util.BoundingBoxE6 GetBoundingBoxFromCoords (int left, int top, int right, int bottom, int zoom)
		{
			...
			return global::Java.Lang.Object.GetObject<global::Osmdroid.Util.BoundingBoxE6> (JNIEnv.CallStaticObjectMethod  (class_ref, id_getBoundingBoxFromCoords_IIIII, new JValue (left), new JValue (top), new JValue (right), new JValue (bottom), new JValue (zoom)), JniHandleOwnership.TransferLocalRef);
		}
		...
		public static global::Osmdroid.Util.GeoPoint ProjectPoint (int x, int y, int aZoom)
		{
			...
			return global::Java.Lang.Object.GetObject<global::Osmdroid.Util.GeoPoint> (JNIEnv.CallStaticObjectMethod  (class_ref, id_projectPoint_III, new JValue (x), new JValue (y), new JValue (aZoom)), JniHandleOwnership.TransferLocalRef);
		}
