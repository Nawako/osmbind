...
namespace Microsoft.Mappoint {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='microsoft.mappoint']/class[@name='TileSystem']"
	[global::Android.Runtime.Register ("microsoft/mappoint/TileSystem", DoNotGenerateAcw=true)]
	public sealed partial class TileSystem : global::Java.Lang.Object {


		static IntPtr mTileSize_jfieldId;

		// Metadata.xml XPath field reference: path="/api/package[@name='microsoft.mappoint']/class[@name='TileSystem']/field[@name='mTileSize']"
		[Register ("mTileSize")]
		protected static int MTileSize {
			get {
				if (mTileSize_jfieldId == IntPtr.Zero)
					mTileSize_jfieldId = JNIEnv.GetStaticFieldID (class_ref, "mTileSize", "I");
				return JNIEnv.GetStaticIntField (class_ref, mTileSize_jfieldId);
			}
			set {
				if (mTileSize_jfieldId == IntPtr.Zero)
					mTileSize_jfieldId = JNIEnv.GetStaticFieldID (class_ref, "mTileSize", "I");
				JNIEnv.SetStaticField (class_ref, mTileSize_jfieldId, value);
			}
		}
		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("microsoft/mappoint/TileSystem", ref java_class_handle);
			}
		}
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='microsoft.mappoint']/class[@name='TileSystem']/constructor[@name='TileSystem' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		...
		public static int TileSize {
			// Metadata.xml XPath method reference: path="/api/package[@name='microsoft.mappoint']/class[@name='TileSystem']/method[@name='getTileSize' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='microsoft.mappoint']/class[@name='TileSystem']/method[@name='setTileSize' and count(parameter)=1 and parameter[1][@type='int']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='microsoft.mappoint']/class[@name='TileSystem']/method[@name='GroundResolution' and count(parameter)=2 and parameter[1][@type='double'] and parameter[2][@type='int']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='microsoft.mappoint']/class[@name='TileSystem']/method[@name='LatLongToPixelXY' and count(parameter)=4 and parameter[1][@type='double'] and parameter[2][@type='double'] and parameter[3][@type='int'] and parameter[4][@type='android.graphics.Point']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='microsoft.mappoint']/class[@name='TileSystem']/method[@name='MapScale' and count(parameter)=3 and parameter[1][@type='double'] and parameter[2][@type='int'] and parameter[3][@type='int']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='microsoft.mappoint']/class[@name='TileSystem']/method[@name='MapSize' and count(parameter)=1 and parameter[1][@type='int']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='microsoft.mappoint']/class[@name='TileSystem']/method[@name='PixelXYToLatLong' and count(parameter)=4 and parameter[1][@type='int'] and parameter[2][@type='int'] and parameter[3][@type='int'] and parameter[4][@type='org.osmdroid.util.GeoPoint']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='microsoft.mappoint']/class[@name='TileSystem']/method[@name='PixelXYToTileXY' and count(parameter)=3 and parameter[1][@type='int'] and parameter[2][@type='int'] and parameter[3][@type='android.graphics.Point']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='microsoft.mappoint']/class[@name='TileSystem']/method[@name='QuadKeyToTileXY' and count(parameter)=2 and parameter[1][@type='java.lang.String'] and parameter[2][@type='android.graphics.Point']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='microsoft.mappoint']/class[@name='TileSystem']/method[@name='TileXYToPixelXY' and count(parameter)=3 and parameter[1][@type='int'] and parameter[2][@type='int'] and parameter[3][@type='android.graphics.Point']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='microsoft.mappoint']/class[@name='TileSystem']/method[@name='TileXYToQuadKey' and count(parameter)=3 and parameter[1][@type='int'] and parameter[2][@type='int'] and parameter[3][@type='int']]"
