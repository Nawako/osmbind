...
namespace Osmdroid.TileProvider.Modules {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='org.osmdroid.tileprovider.modules']/class[@name='ZipFileArchive']"
	[global::Android.Runtime.Register ("org/osmdroid/tileprovider/modules/ZipFileArchive", DoNotGenerateAcw=true)]
	public partial class ZipFileArchive : global::Java.Lang.Object, global::Osmdroid.TileProvider.Modules.IArchiveFile {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("org/osmdroid/tileprovider/modules/ZipFileArchive", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (ZipFileArchive); }
		}

		protected ZipFileArchive (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}
...
#pragma warning disable 0169
		...
		{
			global::Osmdroid.TileProvider.Modules.ZipFileArchive __this = global::Java.Lang.Object.GetObject<global::Osmdroid.TileProvider.Modules.ZipFileArchive> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			__this.Close ();
		}
#pragma warning restore 0169

		static IntPtr id_close;
		// Metadata.xml XPath method reference: path="/api/package[@name='org.osmdroid.tileprovider.modules']/class[@name='ZipFileArchive']/method[@name='close' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.osmdroid.tileprovider.modules']/class[@name='ZipFileArchive']/method[@name='getInputStream' and count(parameter)=2 and parameter[1][@type='org.osmdroid.tileprovider.tilesource.ITileSource'] and parameter[2][@type='org.osmdroid.tileprovider.MapTile']]"
		...
		static IntPtr id_getZipFileArchive_Ljava_io_File_;
		// Metadata.xml XPath method reference: path="/api/package[@name='org.osmdroid.tileprovider.modules']/class[@name='ZipFileArchive']/method[@name='getZipFileArchive' and count(parameter)=1 and parameter[1][@type='java.io.File']]"
		[Register ("getZipFileArchive", "(Ljava/io/File;)Lorg/osmdroid/tileprovider/modules/ZipFileArchive;", "")]
		public static global::Osmdroid.TileProvider.Modules.ZipFileArchive GetZipFileArchive (global::Java.IO.File pFile)
		{
			if (id_getZipFileArchive_Ljava_io_File_ == IntPtr.Zero)
				id_getZipFileArchive_Ljava_io_File_ = JNIEnv.GetStaticMethodID (class_ref, "getZipFileArchive", "(Ljava/io/File;)Lorg/osmdroid/tileprovider/modules/ZipFileArchive;");
			global::Osmdroid.TileProvider.Modules.ZipFileArchive __ret = global::Java.Lang.Object.GetObject<global::Osmdroid.TileProvider.Modules.ZipFileArchive> (JNIEnv.CallStaticObjectMethod  (class_ref, id_getZipFileArchive_Ljava_io_File_, new JValue (pFile)), JniHandleOwnership.TransferLocalRef);
			return __ret;
		}
