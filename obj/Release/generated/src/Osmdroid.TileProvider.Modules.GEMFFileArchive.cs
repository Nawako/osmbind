...
namespace Osmdroid.TileProvider.Modules {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='org.osmdroid.tileprovider.modules']/class[@name='GEMFFileArchive']"
	[global::Android.Runtime.Register ("org/osmdroid/tileprovider/modules/GEMFFileArchive", DoNotGenerateAcw=true)]
	public partial class GEMFFileArchive : global::Java.Lang.Object, global::Osmdroid.TileProvider.Modules.IArchiveFile {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("org/osmdroid/tileprovider/modules/GEMFFileArchive", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (GEMFFileArchive); }
		}

		protected GEMFFileArchive (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.osmdroid.tileprovider.modules']/class[@name='GEMFFileArchive']/method[@name='close' and count(parameter)=0]"
		...
		static IntPtr id_getGEMFFileArchive_Ljava_io_File_;
		// Metadata.xml XPath method reference: path="/api/package[@name='org.osmdroid.tileprovider.modules']/class[@name='GEMFFileArchive']/method[@name='getGEMFFileArchive' and count(parameter)=1 and parameter[1][@type='java.io.File']]"
		[Register ("getGEMFFileArchive", "(Ljava/io/File;)Lorg/osmdroid/tileprovider/modules/GEMFFileArchive;", "")]
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.osmdroid.tileprovider.modules']/class[@name='GEMFFileArchive']/method[@name='getInputStream' and count(parameter)=2 and parameter[1][@type='org.osmdroid.tileprovider.tilesource.ITileSource'] and parameter[2][@type='org.osmdroid.tileprovider.MapTile']]"
