...
namespace Osmdroid.Views.Overlay {
	...
	public partial class OverlayItem : global::Java.Lang.Object {
		...
		[Register ("mGeoPoint")]
		protected global::Osmdroid.Util.GeoPoint MGeoPoint {
			get {
		...
		public OverlayItem (string aTitle, string aSnippet, global::Osmdroid.Util.GeoPoint aGeoPoint) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
		...
		public OverlayItem (string aUid, string aTitle, string aDescription, global::Osmdroid.Util.GeoPoint aGeoPoint) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
...
#pragma warning restore 0169
		...
		public virtual global::Osmdroid.Util.GeoPoint Point {
			...
			get {
				...
				if (GetType () == ThresholdType)
					return global::Java.Lang.Object.GetObject<global::Osmdroid.Util.GeoPoint> (JNIEnv.CallObjectMethod  (Handle, id_getPoint), JniHandleOwnership.TransferLocalRef);
				else
					return global::Java.Lang.Object.GetObject<global::Osmdroid.Util.GeoPoint> (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getPoint", "()Lorg/osmdroid/util/GeoPoint;")), JniHandleOwnership.TransferLocalRef);
			}
		}
