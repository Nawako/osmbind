...
namespace Osmdroid.TileProvider.TileSource {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='org.osmdroid.tileprovider.tilesource']/class[@name='XYTileSource']"
	[global::Android.Runtime.Register ("org/osmdroid/tileprovider/tilesource/XYTileSource", DoNotGenerateAcw=true)]
	public partial class XYTileSource : global::Osmdroid.TileProvider.TileSource.OnlineTileSourceBase {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("org/osmdroid/tileprovider/tilesource/XYTileSource", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (XYTileSource); }
		}

		protected XYTileSource (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Ljava_lang_String_Lorg_osmdroid_ResourceProxy_string_IIILjava_lang_String_arrayLjava_lang_String_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.osmdroid.tileprovider.tilesource']/class[@name='XYTileSource']/constructor[@name='XYTileSource' and count(parameter)=7 and parameter[1][@type='java.lang.String'] and parameter[2][@type='org.osmdroid.ResourceProxy.string'] and parameter[3][@type='int'] and parameter[4][@type='int'] and parameter[5][@type='int'] and parameter[6][@type='java.lang.String'] and parameter[7][@type='java.lang.String[]']]"
		[Register (".ctor", "(Ljava/lang/String;Lorg/osmdroid/ResourceProxy$string;IIILjava/lang/String;[Ljava/lang/String;)V", "")]
		public XYTileSource (string aName, global::Osmdroid.ResourceProxyString aResourceId, int aZoomMinLevel, int aZoomMaxLevel, int aTileSizePixels, string aImageFilenameEnding, string[] aBaseUrl) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			if (GetType () != typeof (XYTileSource)) {
				SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Osmdroid.TileProvider.TileSource.XYTileSource __this = global::Java.Lang.Object.GetObject<global::Osmdroid.TileProvider.TileSource.XYTileSource> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.osmdroid.tileprovider.tilesource']/class[@name='XYTileSource']/method[@name='getTileURLString' and count(parameter)=1 and parameter[1][@type='org.osmdroid.tileprovider.MapTile']]"
